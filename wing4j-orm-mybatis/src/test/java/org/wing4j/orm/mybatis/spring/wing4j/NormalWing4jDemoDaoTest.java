package org.wing4j.orm.mybatis.spring.wing4j;
...
import org.wing4j.orm.mybatis.spring.jpa.NormalJPADemoDao;
import org.wing4j.orm.mybatis.spring.jpa.NormalJPADemoEntity;
...
@ContextConfiguration(locations = {"classpath*:testContext-orm-wing4j.xml"})
public class NormalWing4jDemoDaoTest extends BaseTest {
    @Autowired
    ...
    @Test
    public void testJpa() {
        NormalWing4jDemoDao dao = getBean(NormalWing4jDemoDao.class);
        NormalWing4jDemoEntity entity = new NormalWing4jDemoEntity();
        ...
        dao.insert(entity);
        NormalWing4jDemoEntity selectEntity = dao.selectByPrimaryKey(entity.getSerialNo());
