...
public class UpdateByPrimaryKeySelectiveMappedStatementBuilderTest extends BaseTest {
    ...
    public void testBuild() throws Exception {
        ...
        MappedStatementBuilder builder = new UpdateByPrimaryKeySelectiveMappedStatementBuilder(config, DemoCrudMapper.class);
        builder.setKeywordMode(WordMode.lowerCase);
        builder.setSqlMode(WordMode.lowerCase);
        builder.setSchemaMode(TableNameMode.auto);
        builder.setPrefixMode(TableNameMode.auto);
        ...
        config.addMappedStatement(ms);
        SqlSession sqlSession = new DefaultSqlSession(config, executor, false);
        int updateCnt = sqlSession.update(Constants.UPDATE_BY_PRIMARY_KEY_SELECTIVE, demoEntity);
